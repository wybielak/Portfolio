...
export default function ProjectCard({ project }) {
  ...
  return (
    <>
      ...
      <div className={`mb-4 relative border-0 rounded-3xl ${!isLoaded ? "hidden" : ""}`}>
        <img className="object-cover border-0 rounded-3xl" src={project.photo} alt={project.name} onLoad={() => setIsLoaded(true)} />
